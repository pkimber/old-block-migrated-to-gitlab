...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'block.page': {
            'Meta': {'object_name': 'Page', 'ordering': "['order', 'slug', 'slug_menu']", 'unique_together': "(('slug', 'slug_menu'),)"},
        ...
        'block.pagesection': {
            'Meta': {'object_name': 'PageSection', 'ordering': "('page__slug', 'section__slug')", 'unique_together': "(('page', 'section'),)"},
